...
out.println( "</ul>" );
      ...
      out.write("\n");
      out.write("<form action=\"announcementAdd.jsp\" method=\"POST\">\n");
      out.write("<textarea name=\"announcement\" cols=\"60\" rows=\"1\"></textarea><br />\n");
      out.write("<input type=\"submit\" value=\"Post new announcement\" />(more than 10 chars)\n");
      out.write("</body>\n");
      out.write("</html</form>");
    } catch (Throwable t) {
